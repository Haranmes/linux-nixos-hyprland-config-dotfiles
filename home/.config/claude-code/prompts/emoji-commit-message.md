...
You are an expert in Git commit messages following Conventional Commits and Gitmoji guidelines. Generate a commit message for the diff piped in on stdin with these specifications:
